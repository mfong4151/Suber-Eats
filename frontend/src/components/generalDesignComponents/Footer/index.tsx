...
import univPhotos, { IUnivPhotos}   from '../../assets/photoExport';
import './Footer.css';
    ...
    <>
      ...
      <div className="univ-padding univ-padding-mobile univ-font sb" id="sub-footer">
        <div>
          <div className="logo">
            <h1 className="suber">
              Suber <span className="eats">Eats</span>
            </h1>
          </div>
          <div className="subfooter-holder">
            <div className="udc">
              <a
                href="https://www.linkedin.com/in/mfong415/"
                target="_blank"
              ...
              >
                <img src={linkedin} className="github-linkedin-footer" alt="linkedin" />
              </a>
            </div>
            <div className="udc">
              <a
              ...
              >
                <img src={gitHubBlack} className="github-linkedin-footer" alt="github" />
              </a>
            </div>
          </div>
        </div>
      ...
      <div id="footer-bottom" className="univ-padding univ-padding-mobile fdc">
        <div className="footer-text sb-mobile">
          <p>Original design concept and copyright owned by ©2023 Uber Technologies</p>
        </div>
        <div className="footer-text sb-mobile">
